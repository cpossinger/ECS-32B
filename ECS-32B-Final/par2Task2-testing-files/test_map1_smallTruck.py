...
m = setupMap("/autograder/source/tests/map1.txt")



class TestMap1SmallTruck(unittest.TestCase):
    @weight(0.5)
    def test1(self):
        """map1SmallTruck test 1 (0.5 point)"""
        packages = setupPackages("/autograder/source/tests/packages1.txt")
    ...
    @weight(0.5)
    def test2(self):
        """map1SmallTruck test 2 (0.5 point)"""
        packages = setupPackages("/autograder/source/tests/packages1.txt")
        truck = Truck("truck", 3, "UPS")
        deliveryService(m, truck, packages)
