...
class TestMap3Packages4(unittest.TestCase):
    @weight(0.5)
    def test1(self):
        """map3_packages4 test 1 (0.5 point)"""
    ...
    @weight(0.5)
    def test2(self):
        """map3_packages4 test 2 (0.5 point)"""
        packages = setupPackages("/autograder/source/tests/packages4.txt")
        truck = Truck("truck", 5, "UPS1")
        deliveryService(m, truck, packages)
